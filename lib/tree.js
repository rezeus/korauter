...
// TODO Original author attribution
...
class node {
  ...
  search(path) {
    ...
    walk: while (true) {
          ...
          switch (n.type) {
            case PARAM:
              ...
              if (end < path.length) {
                ...
                // ... but we can't
                return { handler: record.handler, params, meta: record.meta };
              }
      ...
      return (record)
        ? { handler: record.handler, params, meta: record.meta }
        : { handler: null, params, meta: {} };
    }
  }
}
